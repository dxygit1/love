...
export function WelcomeScreenDoILikeHer({ onStart }: WelcomeScreenDoILikeHerProps) {
    ...
    return (
        <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="w-full min-h-screen flex flex-col items-center pt-28 pb-20 relative overflow-hidden bg-gradient-to-br from-sky-50 via-white to-blue-50"
        >
                        ...
                        <section>
                            ...
                            <div className="space-y-6">
                                <div className="bg-white/40 rounded-xl p-5 border border-white/50">
                                    ...
                                    <p className="text-base text-gray-600 leading-relaxed pl-6 border-l-2 border-blue-100">
