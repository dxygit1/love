            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div className="relative w-full mb-6 scale-[0.75] sm:scale-[0.85] md:scale-100 origin-top">
                            <svg
                                viewBox="-10 0 520 74"
                                width="100%"
                        ...
                        <div className="w-full mx-auto space-y-2 scale-[0.75] sm:scale-[0.85] md:scale-100 origin-top">
