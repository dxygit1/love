        ...
        <main className="min-h-screen flex flex-col bg-gradient-to-br from-rose-50 via-white to-indigo-50">
            <div className="flex-grow container mx-auto px-4 pt-24 pb-12 max-w-3xl">
                <div className="text-center mb-12">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800 mb-4">用户协议</h1>
                ...
                <div className="space-y-8 bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-sm border border-white/50 text-gray-600 leading-relaxed text-sm md:text-base">
                    <section>
                        <h2 className="text-lg font-bold text-gray-800 mb-3">1. 条款接受</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-gray-800 mb-3">2. 服务性质</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-gray-800 mb-3">3. 知识产权</h2>
                        <p>
                            本网站的所有内容、设计、图形和代码均受版权法保护。未经许可，不得复制或用于商业用途。
                        </p>
                    </section>
                    <section>
                        <h2 className="text-lg font-bold text-gray-800 mb-3">4. 免责声明</h2>
                        <p>
