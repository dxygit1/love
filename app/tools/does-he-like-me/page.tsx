...
import { results } from "@/lib/quiz-data-does-he-like-me";
import { ArrowLeft, RefreshCw } from "lucide-react";
import Link from "next/link";
import { useLanguage } from "@/contexts/LanguageContext";

export default function DoesHeLikeMeToolPage() {
    const { t } = useLanguage();
    const [score, setScore] = useState<number>(85);
    const [personName, setPersonName] = useState<string>("");
    // Default gender for "Does He Like Me" usually targets a 'he' (male), 
    // but ResultScreen allows changing it if needed or we can default to male.
        ...
        <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row pt-20 md:pt-0">
            ...
            <div className="w-full md:w-80 bg-white border-r border-gray-200 p-6 flex flex-col z-10 shadow-xl overflow-y-auto h-auto md:h-screen">
                <div className="mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">{t("tools.does_he_like_me_title")}</h1>
                ...
                <div className="space-y-6">
                    ...
                    <div className="pt-6 border-t border-gray-100">
                        ...
                        <div className="bg-gray-50 p-3 rounded-lg text-sm space-y-1">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-bold text-blue-600 text-right">{result.titleEn}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pt-6 border-t border-gray-100">
                        <XiaohongshuGenerator
                            type="does-he-like-me"
                            data={{
                                quizName: "暧昧情感测试", // Neutral name for AI
                                score,
                                resultTitle: result.titleZh,
                                partnerName: personName || "TA" // Default to "TA" if empty
                            }}
                        />
                    </div>
