        ...
        <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row pt-20 md:pt-0">
            ...
            <div className="w-full md:w-80 bg-white border-r border-gray-200 p-6 flex flex-col z-10 shadow-xl overflow-y-auto h-auto md:h-screen">
                <div className="mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">{t("tools.love_quiz_title")}</h1>
                    ...
                    <div className="pt-6 border-t border-gray-100">
                        ...
                        <div className="bg-gray-50 p-3 rounded-lg text-sm space-y-1">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-bold text-pink-600 text-right">{result.titleEn}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pt-6 border-t border-gray-100">
                        <XiaohongshuGenerator
                            ...
                            data={{
                                quizName: "恋爱测试",
                                score,
                                resultTitle: result.titleZh, // Default to Chinese title for copy
